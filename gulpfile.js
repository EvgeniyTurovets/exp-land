...
let { src, dest } = require('gulp'),
  ...
  scss = require('gulp-sass')(require('sass')), // Конвертирует scss в css
...
let build = gulp.series(clean, gulp.parallel(jslibs, js, csslibs, css, html, fonts, fontsicon, images));
